...
function Login(props) {
  ...
  useEffect(() => {
    ...
    if (window.top !== window.self) {
      ...
      if (document.getElementById("loginButtonContainer"))
        document.getElementById("loginButtonContainer").remove();
    } else {
      // not an iframe
    ...
    <div className="container">
      ...
      >
        <img
          ...
          alt=""
        />
        <div id="loginButtonContainer" className="d-grid col-3">
          <button
        ...
        <div id="iframeAlert" className="alert alert-info" role="alert">
          ...
          Or you can visit &nbsp;
          <a
            href="https://mucru.sse.codesandbox.io"
            target="_blank"
            rel="noreferrer"
          >
          https://mucru.sse.codesandbox.io
          </a>
